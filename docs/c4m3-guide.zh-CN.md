...
当前开发版新增 `c4m3-overcast-static-v1`，将 C4M3 初始化时的固定阴天参数应用到**原始** C2M1 `c2m1_highway`。本预设尚待首轮人工 HDR 反射采样和原名实机验收；没有发布新的已接受版本。C5 预设及已接受结果继续保留。
