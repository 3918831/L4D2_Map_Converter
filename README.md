...
| `conversion: generic-replace-v1` | 任意合法地图名 → C5M1 / C4M3 | 新通用路径；C1M1/C3M1 已通过参数保护检查，C1M1 已在独立目录完成原生构建与 84 份 HDR 反射回填；用户已反馈本轮 coop 实测全程无异常，验收限实际观察范围；C3M1→C4M3 已完成原生构建及 44 份 HDR 回填，待人工验收；其他输入按能力检查处理 |
